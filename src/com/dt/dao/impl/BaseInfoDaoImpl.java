...
public class BaseInfoDaoImpl extends HibernateDaoSupport implements BaseInfoDao {
	...
	public List<Object> selectBaseList(Integer project, Integer facility) {
		// TODO Auto-generated method stub
		final StringBuilder sb = new StringBuilder();
		sb.append(
				"select e.Detector_Equipment_Id,e.Detector_Equipment_No,e.Detector_Equipment_Name,er.Detector_EquipmentRoom_Name,et.Detector_EquipmentType_Name,dp.Detector_Project_Name from Detector_Equipment e");
		...
		sb.append(" LEFT JOIN Detector_Project dp ON er.Detector_Project_Id=dp.Detector_Project_Id");
		if (project != 0 && facility != 0) {
	...
	public List<Object> selectEquipmentById(Integer equipmentId) {
		...
		sb.append(
				"  et.Detector_EquipmentType_name,er.Detector_EquipmentRoom_name,e.Detector_Equipment_Version,Detector_Equipment_Price,");
		sb.append(
				"  e.Detector_Equipment_TP,Detector_Equipment_Manufacturers,e.Detector_Equipment_ProductionDate,e.Detector_Equipment_UseDate,");
		sb.append(
				"  e.Detector_Equipment_MaintenancePeriod,e.Detector_Equipment_RepairsDate,e.Detector_Equipment_Tel,e.Detector_Equipment_Mobile,");
		sb.append(
				"  e.Detector_Equipment_FactoryNo,e.Detector_Equipment_Lifetime,e.Detector_Equipment_Director,e.Detector_Equipment_UserID,e.Detector_Equipment_AddDate,");
